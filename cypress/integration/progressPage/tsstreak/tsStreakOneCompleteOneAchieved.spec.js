...
describe('Progress Page', () => {
	before('Open Application & Log In', () => {
		...
		cy.fixture('tsOneCompleteOneAchieved').then(file => {
	...
	it('Member is building a tiny step streak with one complete and one achieved', () => {
		// Navigate to the progress page

		sidebar.getProgressButton().click()

		// Validate UI elememts

		progressPageTSStreak
			.getTSStreakHeader()
			.should('include.text', 'Tiny Step streak')
		progressPageTSStreak.getTSStreakImage().should('exist').and('be.visible')
