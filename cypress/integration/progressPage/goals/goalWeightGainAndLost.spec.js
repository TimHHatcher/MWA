...
describe('Progress Page', () => {
	...
	before('Set up data, open Application, and log in', () => {
		...
		cy.fixture('goals').then(file => {
			...
			file.goals[0].targetValue = 150
			file.goals[0].startValue = 130
			file.goals[0].currentValue = 125
	...
	it('Member has a weight goal set to gain weight and lost weight', () => {
		...
		progressPageGoals.getGoalCurrentValue().should('include.text', '125')
		...
		progressPageGoals.getGoalStartValue().should('include.text', '130')
