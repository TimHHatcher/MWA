...
describe('Home Page', () => {
	...
	it('Member has tiny step feedback icon, selects it, reviews feedback modal, and closes the modal with the Dismiss button', () => {
		...
		// Click the Dismiss button to close the modal popup and validate UI elements

		homePageTinySteps.getFeedbackModalDismissButton().click()
