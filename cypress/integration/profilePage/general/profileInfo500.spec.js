...
describe('Home Page', () => {
	before('Open Application & Log In', () => {
		// Set up motd, coachingInfo, tinySteps, profileInfo, and help-section API intercepts. Return a 500 status code for profileInfo API.
		...
		cy.intercept('GET', Cypress.env('profileInfoAPIEndpoint'), {
			statusCode: 500,
		})
	...
	it('Profile Info API returns 500 status code', () => {
